          ...
          <div className='w-full full-grow flex flex-col bg-slate-900 px-[10%] text-white font-roboto'>
            ...
            <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='w-full flex flex-row'>
              <div className='w-3/5'>
                ...
                <p className='text-[20px] font-light'>•  React.js: Building dynamic user interfaces with stateful components.</p>
                <p className='text-[20px] font-light'>•  Fully responsive applications.</p>
                <p className='text-[20px] font-light'>•  Focused on SPAs (Single-Page-Applications).</p>
                <p className='text-[20px] font-light'>•  UI/UX Implementations: Leveraging various technologies to create intuitive and delightful user experiences.</p>
              </div>
            ...
            <div className='w-full flex flex-col'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  AWS Amplify: Managing backend services, API integration, lambda functions, authentication, and encryption.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Serverless Architectures: Understanding and implementing serverless solutions for efficient development cycles.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Offering many functionalities with only one stack.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Saving time and money not testing backend functionalities.</p>
            ...
            <div className='w-full flex flex-col'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  TailwindCSS: Applying utility-first framework for responsive design and efficient styling.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Figma: Creating components to improve visual engagement on the site. </p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Responsive Web Design: Ensuring websites are accessible and aesthetically pleasing across various devices.</p>
            ...
            <div className='w-full flex flex-col'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Python: Writing clear and efficient code for a variety of applications.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  JavaScript: Implementing interactive features and client-side scripts.</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  PHP: Developing server-side logic and database interactions (prior experience).</p>
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  C++: For embedded systems development with a wide variety of microcontrollers.</p>
            ...
            <div className='w-full flex flex-col'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>•  Git: Proficient in using Git for version control and collaboration.</p>
              <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='w-full flex items-center justify-center my-6 px-[10%]'>
            ...
            <div className='w-full flex flex-col'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>Demonstrated ability to approach complex problems with logical and creative solutions.</p>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>
            ...
            <div className='w-full flex flex-col mb-12'>
              ...
              <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='text-[20px] font-light'>Experience in leading projects from conception to deployment, ensuring timely delivery.</p>
